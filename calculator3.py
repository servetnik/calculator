...
tk.Button(text = '7', background="#bde0ff", font='Courier 10',
          command = lambda : get_number(7)).grid(row = 1, column = 0, stick = 'wens')
tk.Button(text = '8', background="#bde0ff", font='Courier 10',
          command = lambda : get_number(8)).grid(row = 1,column = 1, stick = 'wens')
tk.Button(text = '9', background="#bde0ff", font='Courier 10',
          command = lambda : get_number(9)).grid(row = 1,column = 2, stick = 'wens')
...
tk.Button(text = '1', background="#bde0ff", font='Courier 10',
          command = lambda : get_number(1)).grid(row = 3,column = 0, stick = 'wens')
tk.Button(text = '2', background="#bde0ff", font='Courier 10',
          command = lambda : get_number(2)).grid(row = 3,column = 1, stick = 'wens')
tk.Button(text = '3', background="#bde0ff", font='Courier 10',
          command = lambda : get_number(3)).grid(row = 3,column = 2, stick = 'wens')
...
tk.Button(text = 'x', background="#000000", font='Courier 10', fg='#ffffff',
...
tk.Button(text = 'C', background="#000000", font='Courier 10', fg='#ffffff',
          command = delete_all).grid(row = 1, column = 5, stick = 'wens', rowspan = 4)
tk.Button(text = '<-', background="#000000", font='Courier 10', fg='#ffffff',
          command = delete).grid(row = 0, column = 5, stick = 'wens')
